...
class KeycloakConfigInstrumentedTest {
    ...
    @Test
    fun clientId_isDuqAndroid() {
        assertEquals("duq-android", KeycloakConfig.CLIENT_ID)
    }

    @Test
    fun realm_isDuq() {
        assertEquals("duq", KeycloakConfig.REALM)
    }
    ...
    fun redirectUri_hasCorrectScheme() {
        assertEquals("com.duq.android://oauth/callback", KeycloakConfig.REDIRECT_URI)
    }
    ...
    fun postLogoutRedirectUri_matchesScheme() {
        assertTrue(
            ...
            KeycloakConfig.POST_LOGOUT_REDIRECT_URI.startsWith("com.duq.android://")
        )
    }
    ...
    fun issuerUri_pointsToRealm() {
        ...
        assertTrue(
            ...
            uri.toString().contains("/realms/duq")
        )
    }
