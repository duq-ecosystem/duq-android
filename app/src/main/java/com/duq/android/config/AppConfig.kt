...
object AppConfig {
    ...
    // ru_RU-ruslan-medium (VITS, 22050 Hz, МУЖСКОЙ — Дак мужчина). Все 3 мужских Piper
    // (ruslan/dmitri/denis) среднего качества; ruslan выбран как наименее плохой. Качественный
    // мужской on-device русский = RHVoice (отложен на CMP, см. iOS-CMP-Migration-Plan).
    ...
    const val TTS_SPEAKER_ID = 0          // ruslan — single-speaker
