...
/**
 * Sealed class hierarchy for all Jarvis errors.
...
sealed class JarvisError(val message: String) {
    ...
    class AudioError(message: String, val cause: Throwable? = null) : JarvisError(message) {
        companion object {
    ...
    class WakeWordError(message: String, val cause: Throwable? = null) : JarvisError(message) {
        companion object {
    ...
    class AuthError(message: String, val requiresReauth: Boolean = false) : JarvisError(message) {
        companion object {
